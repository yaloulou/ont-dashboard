<template>
  ...
  <div>
    <div class="fixed end-0 bottom-20">
      ...
      >
        <span class="sr-only">Reglage</span>
    ...
    >
      ...
      >
        <h5 class="text-base grow">Reglage de thème</h5>
      ...
      <div class="h-[calc(100vh-64px)]" data-simplebar>
        ...
        >
          <div class="p-6">
            <h5 class="font-semibold text-sm mb-3">Thème</h5>
          ...
          <div class="p-6 2xl:block hidden">
            <h5 class="font-semibold text-sm mb-3">Largeur du contenu</h5>
            <div class="grid grid-cols-3 gap-2">
              <div class="card-radio">
                <input
                  class="form-radio"
          ...
          <div class="p-6">
            <h5 class="font-semibold text-sm mb-3">Vue de la navigation latérale</h5>
          ...
          <div class="p-6">
            <h5 class="font-semibold text-sm mb-3">Couleur de menu</h5>
          ...
          <div class="p-6">
            <h5 class="font-semibold text-sm mb-3">Couleur de la barre supérieure</h5>
            <div class="grid grid-cols-4 gap-2">
              <div class="card-radio">
                <input
                  class="form-radio"
          ...
          <div class="p-6">
            <h5 class="font-semibold text-sm mb-3">Position de mise en page</h5>
    ...
    handleCustomizer() {
      if (this.useLayout.config.direction == "ltr") {
        document
          ...
          ?.classList.remove("rtl:-translate-x-full");
        if (
          document
            .getElementById("theme-customization")
      ...
      if (this.useLayout.config.direction == "rtl") {
        ...
        document
          .getElementById("theme-customization")
          ?.classList.add("rtl:-translate-x-full");
        this.useLayout.hideBackdrop();
        return;
      }
    },
